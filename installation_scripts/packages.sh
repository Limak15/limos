...
packages=("git" "wget" "fakeroot" "which" "xmonad" "xmonad-contrib" "polybar" "kitty" "rofi" "flameshot" "neovim" "qt5-quickcontrols" "qt5-graphicaleffects" "vlc" "ntfs-3g" "thunar" "slock" "xdg-user-dirs" "xorg-server" "unzip" "mousepad" "lxappearance" "qt6ct" "ly" "kvantum" "lsd" "starship" "dunst" "udiskie" "ffmpegthumbnailer" "xorg" "nm-connection-editor" "feh" "zoxide" "fzf" "base-devel" "plymouth" "alsa-utils" "firefox" "nomacs" "fastfetch")
